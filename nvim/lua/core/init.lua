...
-------------------------------------- options ------------------------------------------
local my_auto_save = true
local my_auto_restore_cursor_position = true
local my_auto_remove_new_lines_comment = true
...
if my_auto_restore_cursor_position then
...
if my_auto_remove_new_lines_comment then
